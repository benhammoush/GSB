...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 21 jan. 2019 à 23:24
...
('a131', '201811', 0, '0.00', '2018-12-08', 'CL'),
('a131', '201812', 0, '0.00', '2019-01-19', 'CL'),
('a131', '201901', 0, '0.00', '2019-01-19', 'CR'),
('a17', '201811', 0, '0.00', '2018-12-16', 'CL'),
('a17', '201812', 0, '0.00', '2019-01-06', 'CL'),
('a17', '201901', 0, '0.00', '2019-01-06', 'CR'),
('a55', '201809', 0, '0.00', '2018-05-18', 'CR'),
('b50', '201811', 0, '0.00', '2018-11-18', 'CR');
...
CREATE TABLE `fraisforfait` (
  ...
  `typefichefrais` int(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `fraisforfait` (`id`, `libelle`, `montant`, `typefichefrais`) VALUES
('1', 'urbaine', '100.00', 1),
('ETP', 'Forfait Etape', '110.00', 0),
('KM', 'Frais Kilométrique', '0.62', 0),
('NUI', 'Nuitée Hôtel', '80.00', 0),
('REP', 'Repas Restaurant', '25.00', 0);
...
(6, 'a17', '201811', 'REFUSE : REFUSE : test', '2018-08-01', '101.00');
...
INSERT INTO `visiteur` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateEmbauche`, `libelle`) VALUES
('a131', 'Villechalane', 'Louis', 'root', 'root', '8 rue des Charmes', '46000', 'Cahors', '2005-12-21', 'comptable'),
('a17', 'Andre', 'David', 'inv', 'inv', '1 rue Petit', '46200', 'Lalbenque', '1998-11-23', 'visiteur'),
